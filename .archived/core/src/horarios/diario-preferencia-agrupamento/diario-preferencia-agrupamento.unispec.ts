...
export const DiarioPreferenciaAgrupamentoView = () =>
  U.View({
...
export const DiarioPreferenciaAgrupamentoFindOneInputView = () =>
  U.View({
...
export const DiarioPreferenciaAgrupamentoFindAllResult = () =>
  PaginatedResultView({
...
export const DiarioPreferenciaAgrupamentoDeclarator = () =>
  CompileOperations({
...
export const DiarioPreferenciaAgrupamentoProvider = LazyModule({
  nodes: [
