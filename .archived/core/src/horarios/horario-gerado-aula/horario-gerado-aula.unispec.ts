...
export const HorarioGeradoAulaView = () =>
  U.View({
...
export const HorarioGeradoAulaFindOneInputView = () =>
  U.View({
...
export const HorarioGeradoAulaFindAllResult = () =>
  PaginatedResultView({
...
export const HorarioGeradoAulaDeclarator = () =>
  CompileOperations({
...
export const HorarioGeradoAulaProvider = LazyModule({
  nodes: [
