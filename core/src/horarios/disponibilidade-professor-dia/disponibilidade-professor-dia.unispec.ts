...
export const DisponibilidadeProfessorDiaView = () =>
  U.View({
...
export const DisponibilidadeProfessorDiaFindOneInputView = () =>
  U.View({
...
export const DisponibilidadeProfessorDiaFindOneResultView = () =>
  U.View({
...
export const DisponibilidadeProfessorDiaInputCreateView = () =>
  U.View({
...
export const DisponibilidadeProfessorDiaInputUpdateView = () =>
  U.View({
...
export const DisponibilidadeProfessorDiaFindAllResult = () =>
  PaginatedResultView({
...
export const DisponibilidadeProfessorDiaDeclarator = () =>
  CompileOperations({
...
export const DisponibilidadeProfessorDiaProvider = LazyModule({
  nodes: [
