...
export const ImagemArquivoEntity = () =>
  CommonEntity({
    id: "uuid",
    dated: true,
...
export const ImagemArquivoView = () =>
  U.View({
...
export const ImagemArquivoFindOneInputView = () =>
  U.View({
...
export const ImagemArquivoFindOneResultView = () =>
  U.View({
...
export const ImagemArquivoProvider = LazyModule({
  nodes: [
    ImagemArquivoEntity,
    ImagemArquivoView,
