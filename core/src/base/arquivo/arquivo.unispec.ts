...
export const ArquivoFindOneInputView = () =>
  U.View({
...
export const ArquivoDeclarator = () =>
  CompileOperations({
...
export const ArquivoProvider = LazyModule({
  nodes: [
    //
    ArquivoEntity,
    ArquivoView,
